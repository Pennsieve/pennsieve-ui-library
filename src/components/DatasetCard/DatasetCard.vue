...
import useFormatMetric from "../../composables/useFormatMetric.js"
import useFormatDate from "../../composables/useFormatDate.js"
import getLicenseAbbr from "../../utils/license-util.js"
  ...
  <div class="dataset-card">
    <div class="dataset-content">
      ...
      <div class="dataset-content-wrap">
        <h3>
          <router-link :to="{ name: 'datasets-datasetId', params: { datasetId: dataset.id }, query: {
                type: 'dataset'
              }}">
            {{ dataset.name }}
          </router-link>
